...
public abstract class BlessedCharacteristicDiscoveredFilter
    extends BlessedObjectFilter<BluetoothGattCharacteristic> {
   ...
   */
  protected BlessedCharacteristicDiscoveredFilter(
