...
public class BlessedCharacteristicDiscoveredTargetCharacteristicFilter
    extends BlessedCharacteristicDiscoveredFilter {
   ...
   */
  public BlessedCharacteristicDiscoveredTargetCharacteristicFilter(
