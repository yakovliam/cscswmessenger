...
public class BCMCallbackImplementation extends BluetoothCentralManagerCallback {
  ...
  public void onConnectedPeripheral(@NotNull BluetoothPeripheral peripheral) {
    CSCSWMessengerBootstrapper.LOGGER.info("Connected to the peripheral with name {}, addr {}",
  ...
  public void onDisconnectedPeripheral(@NotNull BluetoothPeripheral peripheral,
                                       @NotNull BluetoothCommandStatus status) {
    CSCSWMessengerBootstrapper.LOGGER.info("Disconnected from peripheral with name {}",
        peripheral.getName());
  ...
  public void onDiscoveredPeripheral(@NotNull BluetoothPeripheral peripheral,
    ...
    CSCSWMessengerBootstrapper.LOGGER.info("Discovered peripheral with name {}, addr {}",
        peripheral.getName(), peripheral.getAddress());
