...
public class BCMPeripheralConnectionCallbackImplementation extends BluetoothPeripheralCallback {
  ...
  public void onServicesDiscovered(@NotNull BluetoothPeripheral peripheral,
    ...
    CSCSWMessengerBootstrapper.LOGGER.info("Services discovered for peripheral with name {}, {}",
        peripheral.getName(), serviceListString);
  ...
  @Override
  public void onCharacteristicUpdate(@NotNull BluetoothPeripheral peripheral, @NotNull byte[] value,
                                     @NotNull BluetoothGattCharacteristic characteristic,
                                     @NotNull BluetoothCommandStatus status) {
    CSCSWMessengerBootstrapper.LOGGER.info("Characteristic update was called, data received: {}",
  ...
  @Override
  public void onCharacteristicWrite(@NotNull BluetoothPeripheral peripheral, byte @NotNull [] value,
                                    @NotNull BluetoothGattCharacteristic characteristic,
                                    @NotNull BluetoothCommandStatus status) {
  ...
  @Override
  public void onDescriptorRead(@NotNull BluetoothPeripheral peripheral, byte @NotNull [] value,
  ...
  @Override
  public void onDescriptorWrite(@NotNull BluetoothPeripheral peripheral, byte @NotNull [] value,
                                @NotNull BluetoothGattDescriptor descriptor,
                                @NotNull BluetoothCommandStatus status) {
